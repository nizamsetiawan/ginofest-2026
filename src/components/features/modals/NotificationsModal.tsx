      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-[16px] font-black text-[#071e49]">Notifikasi</h3>
                {unreadCount > 0 && (
        ...
        {unreadCount > 0 && (
          <div className="flex justify-end">
            <button
              ...
              className="text-[11px] font-bold text-[#1a73e8] hover:text-[#155fc0] flex items-center gap-1 cursor-pointer"
            >
        ...
        <div className="flex-1 overflow-y-auto space-y-2 pr-1">
          {notifications.map((n) => (
            ...
            >
              <div className="w-8 h-8 rounded-xl bg-white border border-slate-200 flex items-center justify-center shrink-0 mt-0.5 text-[#1a73e8]">
                {n.type === "ai" && <Sparkles className="w-4 h-4 text-[#1a73e8]" />}
              ...
              <div className="flex-1 space-y-0.5">
                <div className="flex items-center justify-between gap-2">
                  <h4 className="text-[12px] font-bold text-[#071e49] leading-snug">
                    {n.title}
                  </h4>
              ...
              {!n.isRead && (
                <div className="w-2 h-2 rounded-full bg-[#1a73e8] shrink-0 mt-2"></div>
              )}
            </div>
          ))}
        </div>
