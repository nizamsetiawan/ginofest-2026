...
const FIRESTORE_COLLECTIONS = [
  ...
  { name: "kcal_users", desc: "Akun Pengguna & Admin Terdaftar" },
  { name: "kcal_session_logs", desc: "Log Sesi Login & Otorisasi Admin" },
  { name: "kcal_masyarakat", desc: "Profil Warga & Data Anak Target MBG" },
  { name: "biometric_scans_history", desc: "Riwayat Biometrik Azure Vision & Gemini" },
  { name: "gscan_qr_claims", desc: "Transaksi Klaim Makanan Porsi Harian MBG" },
  { name: "gscan_notifications", desc: "Log Audit & Notifikasi Sistem Real-time" },
  { name: "gscan_complaints", desc: "Pusat Pengaduan & Keluhan Publik MBG" },
  { name: "gscan_settings", desc: "Konfigurasi Sistem & Pagu Anggaran MBG" },
  { name: "gscan_help_qa", desc: "Basis Pengetahuan Bantuan & FAQ AI Bot" },
  { name: "mbg_menu_plans", desc: "Rencana Pola Menu & Anggaran Bulanan" },
];
