                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1 space-y-1 text-left">
                          ...
                          <p className="text-[10.5px] text-slate-500 font-medium">
                            {item.recommendedMenu?.calories || 680} kkal • {item.recommendedMenu?.akgPercentage || 97}% AKG Porsi Harian
                          </p>
        ...
        {selectedDetailScan && (
          <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-end sm:items-center justify-center p-0 sm:p-4 font-sans animate-in fade-in duration-200">
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 100 }}
              className="bg-white rounded-t-3xl sm:rounded-3xl w-full max-w-md h-[93vh] sm:h-auto max-h-[93vh] sm:max-h-[90vh] flex flex-col shadow-2xl overflow-hidden text-left"
            >
              {/* Top Mobile Drag Handle Pill */}
              <div className="w-full flex justify-center pt-2.5 pb-1 sm:hidden shrink-0">
                <div className="w-12 h-1 bg-slate-200 rounded-full" />
                ...
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2.5 text-left">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-2 py-0.5 rounded-md bg-teal-50 text-[#0FA89B] text-[10px] font-bold border border-teal-200">
                      {selectedDetailScan.recommendedMenu?.akgPercentage || 97}% AKG Porsi Harian
                    </span>
                  </div>
