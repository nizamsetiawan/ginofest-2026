              ...
              {activeTab === "menu" && (
                <div className="space-y-2.5 animate-in fade-in duration-200">
                  ...
                  {[
                    ...
                    const foodVisual = getMenuFoodImage(m.menu, m.side);
                    return (
                      <div key={idx} className="p-3 rounded-2xl bg-white border border-slate-200 shadow-2xs flex items-center gap-3">
                        <div className="relative w-16 h-16 rounded-2xl overflow-hidden shrink-0 border border-slate-100 bg-slate-50 shadow-2xs">
                          <img src={foodVisual.imageUrl} alt={foodVisual.altText} className="w-full h-full object-cover" loading="lazy" />
                        </div>
