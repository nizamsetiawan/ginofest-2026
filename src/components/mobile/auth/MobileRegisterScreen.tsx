      ...
      <div className="flex-1 flex flex-col justify-between max-w-md mx-auto w-full pt-1">
        <div className="space-y-4">
          ...
          <div className="space-y-1.5 pt-1">
            ...
            <div>
              <h1 className="text-[22px] font-black text-ford-blue tracking-tight">Daftar Akun Keluarga</h1>
          ...
          <form onSubmit={(e) => { triggerHaptic(); onRegister(e); }} className="space-y-3.5">
            {/* 1. Nama Lengkap */}
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full h-12 pl-11 pr-4 rounded-2xl bg-[#F8FAFC] border text-[13.5px] font-medium text-ford-blue focus:bg-white focus:outline-none transition-all ${
              ...
              {fieldErrors.fullName && (
                <p className="text-[10.5px] text-brand-red font-semibold">{fieldErrors.fullName}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              {fieldErrors.email && (
                <p className="text-[10.5px] text-brand-red font-semibold">{fieldErrors.email}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              {fieldErrors.phone && (
                <p className="text-[10.5px] text-brand-red font-semibold">{fieldErrors.phone}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              {fieldErrors.district && (
                <p className="text-[10.5px] text-brand-red font-semibold">{fieldErrors.district}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full h-12 pl-11 pr-11 rounded-2xl bg-[#F8FAFC] border text-[13.5px] font-medium text-ford-blue focus:bg-white focus:outline-none transition-all ${
              ...
              {fieldErrors.password && (
                <p className="text-[10.5px] text-brand-red font-semibold">{fieldErrors.password}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              {fieldErrors.confirmPassword && (
                <p className="text-[10.5px] text-brand-red font-semibold">{fieldErrors.confirmPassword}</p>
              )}
            </div>
            ...
            <div className="pt-2">
              <motion.button
                ...
                className="w-full h-12.5 rounded-2xl bg-gradient-to-r from-[#23B5A8] via-[#79D7D2] to-[#23B5A8] hover:opacity-95 text-ford-blue text-[14.5px] font-black tracking-wide shadow-[0_4px_15px_rgba(35,181,168,0.3)] transition-all cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {isSubmittingAuth ? (
                  <>
