    ...
    <Page className="bg-[#F8FAFC] flex flex-col px-5 py-4 overflow-y-auto relative font-sans overscroll-contain min-h-full">
      ...
      <div className="flex items-center justify-between pb-2 mb-1">
        ...
        >
          ...
          <span>{forgotStep === 1 ? "Kembali" : "Sebelumnya"}</span>
        </motion.button>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full h-12 pl-4 pr-10 rounded-2xl bg-[#F8FAFC] border border-slate-200 text-[13px] font-medium text-ford-blue focus:bg-white focus:outline-none focus:border-[#23B5A8] focus:ring-2 focus:ring-[#79D7D2]/25"
                />
                <button
                  type="button"
                  ...
                  aria-label={showForgotPass ? "Sembunyikan kata sandi" : "Tampilkan kata sandi"}
                >
                  {showForgotPass ? <EyeOff className="w-3.5 h-3.5 stroke-[1.75]" /> : <Eye className="w-3.5 h-3.5 stroke-[1.75]" />}
                </button>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-ford-blue p-1 cursor-pointer transition-colors"
                  aria-label={showForgotConfirmPass ? "Sembunyikan konfirmasi kata sandi" : "Tampilkan konfirmasi kata sandi"}
                >
                  {showForgotConfirmPass ? <EyeOff className="w-3.5 h-3.5 stroke-[1.75]" /> : <Eye className="w-3.5 h-3.5 stroke-[1.75]" />}
                </button>
              </div>
            </div>
